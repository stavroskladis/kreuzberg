...
- factbook.xml / factbook.xsl - Example XML/XLS files that you can use
  to test stylesheets
...
curl. Note, you need to have the user agent set in the header or the SEC
site will reject your request.
