...
class Container_d1d331aadb extends _PHPStan_2526f5004\Nette\DI\Container
{
    protected $tags = [
        'phpstan.rules.rule' => [
            '029' => true,
    ...
    public function createService0445(): PHPStan\File\FileExcluderRawFactory
    {
        return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
            ...
            public function __construct(Container_d1d331aadb $container)
            {
    ...
    public function createServiceContainer(): Container_d1d331aadb
    {
        return $this;
    }
    ...
    protected function getStaticParameters(): array
    {
        return [
            ...
            'env' => [
                ...
                'GIT_AUTHOR_DATE' => '@@1777106063 +0200',
                ...
                'PHP_INI_SCAN_DIR' => '',
                'PHPRC' => '/private/var/folders/88/hg20130j1lv82jbjnvw0yq5m0000gn/T/ihe73f6th5f76GtohIp',
                'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/88/hg20130j1lv82jbjnvw0yq5m0000gn/T/ihe73f6th5f76GtohIp|1|*|*|/opt/homebrew/etc/php/8.4/php.ini:/opt/homebrew/etc/php/8.4/conf.d/ext-kreuzberg.ini:/opt/homebrew/etc/php/8.4/conf.d/ext-opcache.ini|3.4.7',
            ],
        ];
    }
