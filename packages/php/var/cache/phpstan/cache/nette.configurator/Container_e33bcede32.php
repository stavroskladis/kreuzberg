...
class Container_e33bcede32 extends _PHPStan_2526f5004\Nette\DI\Container
{
    protected $tags = [
        'phpstan.rules.rule' => [
            '029' => true,
    ...
    public function createService0445(): PHPStan\File\FileExcluderRawFactory
    {
        return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
            ...
            public function __construct(Container_e33bcede32 $container)
            {
    ...
    public function createServiceContainer(): Container_e33bcede32
    {
        return $this;
    }
    ...
    protected function getStaticParameters(): array
    {
        return [
            ...
            'env' => [
                ...
                'PHP_INI_SCAN_DIR' => '',
                'PHPRC' => '/private/var/folders/88/hg20130j1lv82jbjnvw0yq5m0000gn/T/3vg53s74qttc3hXuIEG',
                'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/88/hg20130j1lv82jbjnvw0yq5m0000gn/T/3vg53s74qttc3hXuIEG|1|*|*|/opt/homebrew/etc/php/8.4/php.ini:/opt/homebrew/etc/php/8.4/conf.d/ext-kreuzberg.ini:/opt/homebrew/etc/php/8.4/conf.d/ext-opcache.ini|3.4.7',
            ],
        ];
    }
