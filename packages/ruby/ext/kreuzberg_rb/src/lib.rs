...
#[derive(Clone)]
#[magnus::wrap(class = "Kreuzberg::MetricsLayer")]
pub struct MetricsLayer {
    inner: Arc<kreuzberg::service::layers::metrics::MetricsLayer>,
}

unsafe impl IntoValueFromNative for MetricsLayer {}

impl magnus::TryConvert for MetricsLayer {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &MetricsLayer = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
unsafe impl TryConvertOwned for MetricsLayer {}
...
impl ChunkTextParams {
    fn new(text: String, max_characters: Option<usize>, overlap: Option<usize>, chunker_type: Option<String>) -> Self {
        Self {
            text,
            max_characters,
            overlap,
...
fn take_or_create_slanet(variant: String) -> Option<String> {
    None
}
...
fn take_or_create_table_classifier() -> Option<String> {
    None
}
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_singleton_method("new", function!(LayoutDetectionConfig::new, 3))?;
    class.define_method(
        "confidence_threshold",
    ...
    class.define_singleton_method("new", function!(ChunkingConfig::new, 8))?;
    ...
    class.define_singleton_method("new", function!(EmbeddingConfig::new, 5))?;
    ...
    class.define_singleton_method("new", function!(PageContent::new, 6))?;
    ...
    class.define_singleton_method("new", function!(ChunkTextParams::new, 4))?;
    ...
    module.define_module_function(
        ...
        function!(take_or_create_table_classifier, 0),
    )?;
