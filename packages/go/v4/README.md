...
go get github.com/kreuzberg-dev/kreuzberg/v4@v4.10.0-rc.11
```
...
curl -LO https://github.com/kreuzberg-dev/kreuzberg/releases/download/v4.10.0-rc.11/go-ffi-linux-x86_64.tar.gz
